...
function cv_about_page() {
	...
	echo "<img src='".CV_OSFLAKE_URL."img/autor.jpg' alt='osFlake Arkadiusz Śnieżek' align='left' style='margin-right: 20px;'/>";
		...
		echo "</div>";
		echo "<p><a href='http://www.facebook.com/arkadiusz.sniezek' target='_blank'><img src='".CV_OSFLAKE_URL."img/facebook_icon.png' alt='Arkadiusz Śnieżek' width='30'/></a> ";
		echo "<a href='https://www.linkedin.com/profile/view?id=16943034' target='_blank'><img src='".CV_OSFLAKE_URL."img/linkedin_icon.gif' alt='Arkadiusz Śnieżek' width='30'/></a></p>";
			_e('My other products:',CV_OSFLAKE_DOMAIN_LANG);	
		echo "<p><a href='http://www.bankglosowradiowych.pl/?from=cv' target='_blank'><img src='".CV_OSFLAKE_URL."img/bgr-logo.png' alt='".__('Bank of Voice',CV_OSFLAKE_DOMAIN_LANG)." /></a> ";			
		echo "<a href='http://www.pierogizjasienicy.pl/?from=cv' target='_blank'><img src='".CV_OSFLAKE_URL."img/pierogi-logo.jpg' alt='".__('Vegan and traditional dumplings',CV_OSFLAKE_DOMAIN_LANG)."'/></a></p>";			
